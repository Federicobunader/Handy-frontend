...
export class PostsDetailsComponent {
  ...
  postForm = new FormGroup({
    ...
    rentalPrice: new FormControl (0, [Validators.required, Validators.min(0), Validators.max(1000000000)]),
    salesPrice: new FormControl (0,[ Validators.min(0), Validators.max(1000000000)]),
    depositPrice: new FormControl (0, [Validators.required, Validators.min(0), Validators.max(1000000000)]),
    stock: new FormControl (0, [Validators.required, Validators.min(0), Validators.max(1000000000)]),
    ...
    addressForm : new FormGroup ({
      ...
      postcode: new FormControl (0, [Validators.required,  Validators.min(1), Validators.max(1000000000)]),
